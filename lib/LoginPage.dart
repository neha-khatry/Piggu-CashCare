                ...
                child: Column(
                  children: <Widget>[
                    ...
                    ElevatedButton.icon(
                      ...
                      onPressed: _submit,
                      icon: Icon(Icons.login, color: Colors.white), // Change the icon here
                      label: Text('Login', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.white)),
                    ),
                    SizedBox(height: 20),
                    TextButton(
                      onPressed: () {
